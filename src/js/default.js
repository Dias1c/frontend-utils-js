...
class TagEditor {
  ...
  init_Settings(settings) {
    this.SBlockSelectorName = settings.BlockSelectorName
      ? settings.BlockSelectorName
      : this.SBlockSelectorName;
    this.STextBlockSelectorName = settings.TextBlockSelectorName
      ? settings.TextBlockSelectorName
      : this.STextBlockSelectorName;
    this.SHasDoubles = settings.HasDoubles
      ? settings.HasDoubles
      : this.SHasDoubles;
    ...
    this.SMaxTagLength = settings.MaxTagLength
      ? settings.MaxTagLength
      : this.SMaxTagLength;
